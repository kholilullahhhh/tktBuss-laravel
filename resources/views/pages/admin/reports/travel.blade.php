   ...
   <div class="container-xxl flex-grow-1 container-p-y">
      <div class="d-flex justify-content-between align-items-center mb-4">
         <h4 class="fw-bold mb-0">
            <span class="text-muted fw-light">Laporan /</span> Laporan Perjalanan
         </h4>
         <div class="d-flex gap-2">
            <a href="{{ route('admin.reports.export-travel') }}?{{ http_build_query(array_filter($filters)) }}"
               class="btn btn-outline-success">
               <i class="ri-file-excel-line me-1"></i> Excel
            </a>
            <a href="{{ route('admin.reports.print', 'travel') }}?{{ http_build_query(array_filter($filters)) }}"
      ...
      <div class="card mb-4">
         ...
         <div class="card-body">
            <form method="GET" action="{{ route('admin.reports.travel') }}" class="row g-3 align-items-end">
               <div class="col-md-3">
               ...
               <div class="col-md-2">
                  <a href="{{ route('admin.reports.travel') }}" class="btn btn-outline-secondary w-100">Reset</a>
               </div>
            </form>
         </div>
      </div>
               ...
               <tbody>
                  @forelse($rows as $row)
                     <tr>
                        ...
                        <td>{{ $row['tujuan'] }}</td>
                        <td>
                           <span class="badge bg-label-primary">{{ $row['terjual'] }}/{{ $row['kapasitas'] }}</span>
                        </td>
